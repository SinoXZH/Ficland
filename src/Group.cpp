...
void Family::RandomInitConcubines()
{
    ...
    for (unsigned int i = 0; i < ccbnCount; ++i) {
        ...
        unsigned int ccbnAge = GetNormalDistributionUnsignedNum(CONCUBINE_EVERAGE_AGE, 5);
...
void Family::RandomInitChildren(Character* father, Character* mother)
{
    ...
    for (unsigned int i = 0; i < childrenCount; ++i) {
        ...
        child->InitChara(TITLE_NONE, childJob, husband->charaRace, childAge, Character::RandomInitGender());
